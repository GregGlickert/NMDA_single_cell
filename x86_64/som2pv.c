...
#define nrn_init _nrn_init__som2pv
#define _nrn_initial _nrn_initial__som2pv
#define nrn_cur _nrn_cur__som2pv
#define _nrn_current _nrn_current__som2pv
#define nrn_jacob _nrn_jacob__som2pv
#define nrn_state _nrn_state__som2pv
#define _net_receive _net_receive__som2pv 
#define release release__som2pv 
...
#define DA2 DA2_som2pv
#define DA1 DA1_som2pv
#define GAP1 GAP1_som2pv
#define NE2 NE2_som2pv
#define NEn NEn_som2pv
#define eta eta_som2pv
#define omega omega_som2pv
#define unirand unirand_som2pv
...
#define Beta2 Beta2_som2pv
 double Beta2 = 0.0001;
#define Beta1 Beta1_som2pv
 double Beta1 = 0.001;
#define DA_S DA_S_som2pv
 double DA_S = 1.6;
#define DA_t3 DA_t3_som2pv
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_som2pv
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_som2pv
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_som2pv
 double DAstop2 = 36000;
#define DAstart2 DAstart2_som2pv
 double DAstart2 = 35900;
#define DAstop1 DAstop1_som2pv
 double DAstop1 = 40000;
#define DAstart1 DAstart1_som2pv
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_som2pv
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_som2pv
 double GAPstart1 = 96000;
#define NE_S NE_S_som2pv
 double NE_S = 1;
#define NE_t3 NE_t3_som2pv
 double NE_t3 = 1;
#define NE_t2 NE_t2_som2pv
 double NE_t2 = 1;
#define NE_t1 NE_t1_som2pv
 double NE_t1 = 1;
#define NEstop2 NEstop2_som2pv
 double NEstop2 = 36000;
#define NEstart2 NEstart2_som2pv
 double NEstart2 = 35900;
#define NEstop1 NEstop1_som2pv
 double NEstop1 = 40000;
#define NEstart1 NEstart1_som2pv
...
#define k k_som2pv
 ...
 "k_som2pv", &k_som2pv,
 "GAPstart1_som2pv", &GAPstart1_som2pv,
 "GAPstop1_som2pv", &GAPstop1_som2pv,
 "DAstart1_som2pv", &DAstart1_som2pv,
 "DAstop1_som2pv", &DAstop1_som2pv,
 "DAstart2_som2pv", &DAstart2_som2pv,
 "DAstop2_som2pv", &DAstop2_som2pv,
 "DA_t1_som2pv", &DA_t1_som2pv,
 "DA_t2_som2pv", &DA_t2_som2pv,
 "DA_t3_som2pv", &DA_t3_som2pv,
 "DA_S_som2pv", &DA_S_som2pv,
 "Beta1_som2pv", &Beta1_som2pv,
 "Beta2_som2pv", &Beta2_som2pv,
 "NEstart1_som2pv", &NEstart1_som2pv,
 "NEstop1_som2pv", &NEstop1_som2pv,
 "NEstart2_som2pv", &NEstart2_som2pv,
 "NEstop2_som2pv", &NEstop2_som2pv,
 "NE_t1_som2pv", &NE_t1_som2pv,
 "NE_t2_som2pv", &NE_t2_som2pv,
 "NE_t3_som2pv", &NE_t3_som2pv,
 "NE_S_som2pv", &NE_S_som2pv,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 som2pv /Users/gregglickert/Desktop/NMDA_single_cell-main/modfiles_core/som2pv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Desktop/NMDA_single_cell-main/modfiles_core/som2pv.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS som2pv\n"
