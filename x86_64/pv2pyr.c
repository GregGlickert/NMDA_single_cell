...
#define nrn_init _nrn_init__pv2pyr
#define _nrn_initial _nrn_initial__pv2pyr
#define nrn_cur _nrn_cur__pv2pyr
#define _nrn_current _nrn_current__pv2pyr
#define nrn_jacob _nrn_jacob__pv2pyr
#define nrn_state _nrn_state__pv2pyr
#define _net_receive _net_receive__pv2pyr 
#define release release__pv2pyr 
...
#define DA2 DA2_pv2pyr
#define DA1 DA1_pv2pyr
#define GAP1 GAP1_pv2pyr
#define NE2 NE2_pv2pyr
#define NEn NEn_pv2pyr
#define eta eta_pv2pyr
#define omega omega_pv2pyr
#define unirand unirand_pv2pyr
...
#define Beta2 Beta2_pv2pyr
 double Beta2 = 0.0001;
#define Beta1 Beta1_pv2pyr
 double Beta1 = 0.001;
#define DA_S DA_S_pv2pyr
 double DA_S = 1.6;
#define DA_t3 DA_t3_pv2pyr
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_pv2pyr
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_pv2pyr
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_pv2pyr
 double DAstop2 = 36000;
#define DAstart2 DAstart2_pv2pyr
 double DAstart2 = 35900;
#define DAstop1 DAstop1_pv2pyr
 double DAstop1 = 40000;
#define DAstart1 DAstart1_pv2pyr
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_pv2pyr
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_pv2pyr
 double GAPstart1 = 96000;
#define NE_S NE_S_pv2pyr
 double NE_S = 1;
#define NE_t3 NE_t3_pv2pyr
 double NE_t3 = 1;
#define NE_t2 NE_t2_pv2pyr
 double NE_t2 = 1;
#define NE_t1 NE_t1_pv2pyr
 double NE_t1 = 1;
#define NEstop2 NEstop2_pv2pyr
 double NEstop2 = 36000;
#define NEstart2 NEstart2_pv2pyr
 double NEstart2 = 35900;
#define NEstop1 NEstop1_pv2pyr
 double NEstop1 = 40000;
#define NEstart1 NEstart1_pv2pyr
...
#define k k_pv2pyr
 ...
 "k_pv2pyr", &k_pv2pyr,
 "GAPstart1_pv2pyr", &GAPstart1_pv2pyr,
 "GAPstop1_pv2pyr", &GAPstop1_pv2pyr,
 "DAstart1_pv2pyr", &DAstart1_pv2pyr,
 "DAstop1_pv2pyr", &DAstop1_pv2pyr,
 "DAstart2_pv2pyr", &DAstart2_pv2pyr,
 "DAstop2_pv2pyr", &DAstop2_pv2pyr,
 "DA_t1_pv2pyr", &DA_t1_pv2pyr,
 "DA_t2_pv2pyr", &DA_t2_pv2pyr,
 "DA_t3_pv2pyr", &DA_t3_pv2pyr,
 "DA_S_pv2pyr", &DA_S_pv2pyr,
 "Beta1_pv2pyr", &Beta1_pv2pyr,
 "Beta2_pv2pyr", &Beta2_pv2pyr,
 "NEstart1_pv2pyr", &NEstart1_pv2pyr,
 "NEstop1_pv2pyr", &NEstop1_pv2pyr,
 "NEstart2_pv2pyr", &NEstart2_pv2pyr,
 "NEstop2_pv2pyr", &NEstop2_pv2pyr,
 "NE_t1_pv2pyr", &NE_t1_pv2pyr,
 "NE_t2_pv2pyr", &NE_t2_pv2pyr,
 "NE_t3_pv2pyr", &NE_t3_pv2pyr,
 "NE_S_pv2pyr", &NE_S_pv2pyr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pv2pyr /Users/gregglickert/Desktop/NMDA_single_cell-main/modfiles_core/pv2pyr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Desktop/NMDA_single_cell-main/modfiles_core/pv2pyr.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS pv2pyr\n"
